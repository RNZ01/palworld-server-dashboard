...
const REFRESH_INTERVAL_MS = 5000 // 5s player positions: REST /players is served on the game thread — measured ~1.2pp tick cost per req/s on a live 15-player server
